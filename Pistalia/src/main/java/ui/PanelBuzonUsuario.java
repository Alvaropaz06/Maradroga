...
public class PanelBuzonUsuario extends JPanel {
    ...
    private void cargarMensajes() {
        ...
        if (lista.isEmpty()) {
            ...
            for (Mensaje m : lista) {
                ...
                panelLista.add(Box.createVerticalStrut(15)); // Un poco más de espacio entre tarjetas
            }
        }
    ...
    private JPanel crearTarjetaMensaje(Mensaje m) {
        JPanel fila = new JPanel() {
            // ¡ESTO ES LA MAGIA QUE EVITA QUE SE ESTIRE HACIA ABAJO INFINITAMENTE!
            @Override
            ...
            @Override protected void paintComponent(Graphics g) {
                ...
                // Color de la línea lateral
                boolean respondido = m.getRespuesta() != null && !m.getRespuesta().isEmpty();
                g2.setColor(respondido ? ACCENT_GREEN : new Color(255, 165, 60));
        ...
        // Alineamos todo estrictamente a la izquierda (.LEFT_ALIGNMENT)
        ...
        // Reducimos un poco el ancho del div a 450px para evitar el scroll horizontal
        JLabel lblTexto = new JLabel("<html><div style='width: 450px; color: white; padding-bottom: 5px;'>" + m.getTextoMensaje() + "</div></html>");
        ...
        if (m.getRespuesta() != null && !m.getRespuesta().isEmpty()) {
            ...
            pnlResp.setAlignmentX(Component.LEFT_ALIGNMENT); // Alinear el panel respuesta a la izquierda

            JLabel lblResp = new JLabel("<html><div style='width: 430px; color: #00e676;'><b>Respuesta Admin:</b><br>" + m.getRespuesta() + "</div></html>");
            ...
            lblPend.setAlignmentX(Component.LEFT_ALIGNMENT);
            fila.add(lblPend);
        }
